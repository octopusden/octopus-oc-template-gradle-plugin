...
abstract class OcTemplateService
    @Inject
    constructor(
        private val execOperations: ExecOperations,
    ) : BuildService<OcTemplateService.Parameters>,
        AutoCloseable {
        ...
        private fun areAllPodsReady(): Boolean = podResources.all { podName -> isPodReady(podName) }
