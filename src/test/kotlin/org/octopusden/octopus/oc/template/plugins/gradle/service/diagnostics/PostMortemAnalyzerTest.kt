...
class PostMortemAnalyzerTest {
    @Test
    fun `classifies clean run as no resource problem`(
        @TempDir dir: File,
    ) {
    ...
    @Test
    fun `detects OOMKilled pod and classifies as likely resource problem`(
        @TempDir dir: File,
    ) {
    ...
    @Test
    fun `detects quota pressure and FailedScheduling`(
        @TempDir dir: File,
    ) {
    ...
    @Test
    fun `detects CPU quota pressure`(
        @TempDir dir: File,
    ) {
